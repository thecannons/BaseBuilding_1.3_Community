...
action = "closeDialog 0; nul = [keyCode, CODEINPUT, accessedObject] execVM 'dayz_code\external\keypad\fnc_keyPad\codeCompare.sqf';";
};
class BAbort : B7 {
y = 0.72;
text = "";
soundClick[] = {"\dayz_sfx\action\cell\dtmf_star.ogg",0.6,1};
action = "closeDialog 0; keyCode = []; CODEINPUT = [];	addUIDCode = false; removeUIDCode = false; globalAuthorizedUID = [];";
};
class KeypadImage {
idc = -1;
type = CT_STATIC;
