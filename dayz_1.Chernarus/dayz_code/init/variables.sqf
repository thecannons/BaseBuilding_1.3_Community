...
/********************************************************* Miscellaneous Settings *********************************************************/
	...
	//If your server restarts on a regular interval you can set the interval here to stop players duping items by removing them right before a restart, set it to the number of minutes your server is up for
	restarttime				= 99999;
